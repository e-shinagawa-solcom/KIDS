...
// 受注履歴情報を取得SQL
$strQuery = fncGetOrdersByStrOrderCodeSQL($aryData["strOrderCode"], $aryData["lngOrderDetailNo"], $aryData["lngRevisionNo"]);
...
foreach ($records as $i => $record) {
    ...
    $trBody->setAttribute("id", $record["strordercode"] . "_" . $record["lngorderdetailno"] . "_" . $record["lngrevisionno"]);
