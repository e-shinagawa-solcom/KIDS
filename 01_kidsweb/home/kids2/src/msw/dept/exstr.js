...
function Msw2ChgEtoJ( MswCount )
{
	...
	if ( MswCount == 0 )
	{
		...
		///// SEGMENTS /////
		SegA01_1.innerText = 'Dept code';
		SegA01_2.innerText = 'Dept name';
	...
	else if ( MswCount == 1 )
	{
		...
		///// SEGMENTS /////
		SegA01_1.innerText = '部門コード';
		SegA01_2.innerText = '部門名称';
		...
		///// SEGMENTS /////
		SegC01_1.innerText = '担当者コード';
		SegC01_2.innerText = '担当者名称';
