...
//--------------------------------------------------------------------------------------------------------------------
// 登録確認用(日本語)
var registTableJ = '<table width="90%" cellpadding="5" cellspacing="1" border="0" bgcolor="#6f8180" align="center"><tr class="SegColumn"><td>下記の内容で登録しますか？</td></tr><tr><td bgcolor="#f1f1f1"><a href="#" onclick="window.close();return false;"><img onfocus="CloseJOn( this );" onblur="CloseJOff( this );" onmousedown="fncAlphaOn( this );" onmouseup="fncAlphaOff( this );" onmouseover="CloseJOn( this );" onmouseout="CloseJOff( this );fncAlphaOff( this );" src="/img/type01/cmn/seg/close_off_ja_bt.gif" width="72" height="20" border="0" alt="CLOSE"></a>&nbsp;&nbsp;<a href="#" onclick="window.form1.submit();return false;"><img onfocus="GrayRegistJOn( this );" onblur="GrayRegistJOff( this );" onmousedown="fncAlphaOn( this );" onmouseup="fncAlphaOff( this );" onmouseover="GrayRegistJOn(this)" onmouseout="GrayRegistJOff(this);fncAlphaOff( this );" src="/img/type01/cmn/querybt/regist_gray_off_ja_bt.gif" width="72" height="20" border="0" alt="登録"><a></td></tr></table>';
// 登録確認用(英語)
var registTableE = '<table width="90%" cellpadding="5" cellspacing="1" border="0" bgcolor="#6f8180" align="center"><tr class="SegColumn"><td>Does it register from the following contents?</td></tr><tr><td bgcolor="#f1f1f1"><a href="#" onclick="window.close();return false;"><img onfocus="CloseEOn( this );" onblur="CloseEOff( this );" onmousedown="fncAlphaOn( this );" onmouseup="fncAlphaOff( this );" onmouseover="CloseEOn( this );" onmouseout="CloseEOff( this );fncAlphaOff( this );" src="/img/type01/cmn/seg/close_off_en_bt.gif" width="72" height="20" border="0" alt="CLOSE"></a>&nbsp;&nbsp;<a href="#" onclick="window.form1.submit();return false;"><img onfocus="GrayRegistEOff( this );" onblur="GrayRegistEOff( this );" onmousedown="fncAlphaOn( this );" onmouseup="fncAlphaOff( this );" onmouseover="GrayRegistEOn(this);fncAlphaOff( this );" onmouseout="GrayRegistEOff(this);fncAlphaOff( this );" src="/img/type01/cmn/querybt/regist_gray_off_en_bt.gif" width="72" height="20" border="0" alt="REGIST"><a></td></tr></table>';
