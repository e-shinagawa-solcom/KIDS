...
//						g_arySubMenu['es'][0]	= '見積原価登録';
						...
						g_arySubMenu['po'][0]	= '発注検索';
						g_arySubMenu['po'][1]	= '発注書修正';

						g_arySubMenu['sc'][0]	= '売上(納品書)登録';
						g_arySubMenu['sc'][1]	= '売上検索';
						g_arySubMenu['sc'][2]	= '納品書検索';
						...
						g_arySubMenu['list'][3]	= '金型依頼書';
						g_arySubMenu['list'][4]	= '納品伝票';
						g_arySubMenu['list'][5]	= '請求書';
