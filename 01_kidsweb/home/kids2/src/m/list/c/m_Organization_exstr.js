...
//////////////////////////////////////////////////////////////////
////////// ヘッダーイメージの生成 //////////
var headerAJ = '<img src="' + h_organizationJ + '" width="949" height="30" border="0" alt="組織マスタ">';
var headerAE = '<img src="' + h_organizationE + '" width="949" height="30" border="0" alt="ORGANIZATION MASTER">';
...
function ChgEtoJ( g_lngCode )
{
	...
	if ( g_lngCode == 0 )
	{
		...
		{
			Column0.innerText	= 'Organization code';
		}

		if( typeof(Column1) != 'undefined' )
		{
			Column1.innerText	= 'Organization name';
		}
	...
	else if ( g_lngCode == 1 )
	{
		...
		if( typeof(Column0) != 'undefined' )
		{
			Column0.innerText	= '組織コード';
		}

		if( typeof(Column1) != 'undefined' )
		{
			Column1.innerText	= '組織名称';
		}
