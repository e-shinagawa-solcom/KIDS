...
{
	// オブジェクトの自動レイアウト
	fncInitLayoutObjectModule( objColumn , objInput  , 60 , 224 );
...
//////////////////////////////////////////////////////////////////
////////// ヘッダーイメージの生成 //////////
var headerAJ = '<img src="' + h_transportJ + '" width="949" height="30" border="0" alt="運搬方法マスタ">';
var headerAE = '<img src="' + h_transportE + '" width="949" height="30" border="0" alt="MEANS OF TRANSPORT MASTER">';
...
function ChgEtoJ( g_lngCode )
{
	...
	if ( g_lngCode == 0 )
	{
		...
		{
			Column0.innerText	= 'Means of transport code';
		}

		if( typeof(Column1) != 'undefined' )
		{
			Column1.innerText	= 'Means of transport name';
		}
	...
	else if ( g_lngCode == 1 )
	{
		...
		if( typeof(Column0) != 'undefined' )
		{
			Column0.innerText	= '運搬方法コード';
		}

		if( typeof(Column1) != 'undefined' )
		{
			Column1.innerText	= '運搬方法名称';
		}
