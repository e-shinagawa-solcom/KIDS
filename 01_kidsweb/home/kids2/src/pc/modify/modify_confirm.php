...
for ($i = 0; $i < count($aryDetailData); $i++) {
    ...
    $aryQuery = array();
    $aryQuery[] = "SELECT ";
    $aryQuery[] = "pod.lngorderdetailno, "; // 発注番号
    $aryQuery[] = "pod.lngorderno, "; // 発注明細番号
    $aryQuery[] = "pod.lngorderrevisionno as lngrevisionno, "; // リビジョン番号
    $aryQuery[] = "mpo.strproductcode || '_' || mpo.strrevisecode as strproductcode, "; // 製品コード
    ...
    $aryQuery[] = "pod.curproductprice as curproductprice, "; // 製品価格
...
*/
    ...
    $aryQuery[] = "pod.cursubtotalprice as cursubtotalprice, "; // 小計金額
    $aryQuery[] = "pod.strnote as strdetailnote, "; // 備考
    ...
    $aryQuery[] = "mpo.lngmonetaryunitcode as lngmonetaryunitcode, "; // 通貨単位コード
    ...
    $aryQuery[] = "mpo.lngmonetaryratecode as lngmonetaryratecode, "; // 通貨レートコード
    ...
    $aryQuery[] = "      , mpo1.lngmonetaryunitcode";
    $aryQuery[] = "      , mpo1.lngmonetaryratecode";
    $aryQuery[] = "    from";
