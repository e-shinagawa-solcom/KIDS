...
// クエリの組立て
    ...
    $aryQuery[] = "        LEFT JOIN ( ";
    $aryQuery[] = "          select";
    $aryQuery[] = "            tpd1.lngpurchaseorderno";
    $aryQuery[] = "            , tpd1.lngrevisionno";
    $aryQuery[] = "            , tpd1.lngorderno";
    $aryQuery[] = "            , tpd1.lngorderdetailno";
    $aryQuery[] = "            , tpd1.lngorderrevisionno ";
    $aryQuery[] = "          from";
    $aryQuery[] = "            t_purchaseorderdetail tpd1 ";
    $aryQuery[] = "            inner join ( ";
    $aryQuery[] = "              select";
    $aryQuery[] = "                max(lngrevisionno) lngrevisionno";
    ...
    $aryQuery[] = "                lngpurchaseorderno";
    $aryQuery[] = "            ) mpo_max ";
    $aryQuery[] = "              on tpd1.lngpurchaseorderno = mpo_max.lngpurchaseorderno ";
    $aryQuery[] = "              and tpd1.lngrevisionno = mpo_max.lngrevisionno";
    $aryQuery[] = "          where";
    $aryQuery[] = "            not exists ( ";
    $aryQuery[] = "              select";
    $aryQuery[] = "                tpd2.lngpurchaseorderno ";
    $aryQuery[] = "              from";
    $aryQuery[] = "                ( ";
    $aryQuery[] = "                  SELECT";
    ...
    $aryQuery[] = "                ) as tpd2 ";
    $aryQuery[] = "              where";
    $aryQuery[] = "                tpd2.lngpurchaseorderno = tpd1.lngpurchaseorderno ";
    $aryQuery[] = "                AND tpd2.lngRevisionNo < 0";
    $aryQuery[] = "            )";
    $aryQuery[] = "        ) tpd ";
