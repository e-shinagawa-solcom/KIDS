(function () {
    ...
    $('img.fix.button').on('click', function () {
        ...
        // 別ウィンドウで表示
        var w = window.open(url + '?' + sessionID + '&' + lngStockNo + '&' + lngRevisionNo + '&' + sortList + '&' + childSortList, 'display-detail', 'width=1000, height=600, resizable=yes, scrollbars=yes, menubar=no');
        // w.onunload = function () {
