    ...
    var selectusers = function() {
        ...
        switch (isEmpty(userCode.val()) + isEmpty(userName.val())) {
            ...
            case '00':
                var condition = {
                    data: {
                        QueryName: 'selectInChargeUsersForKwg',
                        Conditions: {
            ...
            case '01':
                var condition = {
                    data: {
                        QueryName: 'selectInChargeUserByInChargeUserNameForKwg',
                        Conditions: {
                            groupCode: groupCode.val(),
            ...
            case '10':
                var condition = {
                    data: {
                        QueryName: 'selectInChargeUserByInChargeUserCodeForKwg',
                        Conditions: {
                            groupCode: groupCode.val(),
            ...
            case '11':
                var condition = {
                    data: {
                        QueryName: 'selectInChargeUserByCodeAndNameForKwg',
                        Conditions: {
                            groupcode: groupCode.val(),
                            userCode: userCode.val(),
                            userName: userName.val()
