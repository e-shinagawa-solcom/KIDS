...
// 2004.03.10 suzukaze update start
	...
	{
		fncOutputError( 9051, DEF_ERROR, "データが異常です", TRUE, "../sc/search/index.php?strSessionID=".$aryData["strSessionID"], $objDB );
	}
...
{
	fncOutputError( 608, DEF_WARNING, "", TRUE, "../sc/search/index.php?strSessionID=".$aryData["strSessionID"], $objDB );
}
