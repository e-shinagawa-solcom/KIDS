...
//===================================================================
//　050413 by kou 意味がない条件を外す　POの出力の関係でlistのライブラリのSQL文を修正した
...
fncDebug( 'po_listouput.txt', $strQuery, __FILE__, __LINE__);
...
//echo "<a href=action.php?strSessionID=" . $aryData["strSessionID"] . "&strReportKeyCode=" . $aryData["strReportKeyCode"] . ">OUTPUT</a>";
