...
function fncPasswdRemind( strURL )
{
	...
	remindW = window.open( strURL , 'passWin' , 'width=690 , height=639 , status=no , scrollbars=no , directories=no , menubar=no , resizable=no , location=no , toolbar=no , left=10 , top=10' );
