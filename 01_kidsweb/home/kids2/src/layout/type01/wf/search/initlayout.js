...
var headerAJ = '<img src="' + wfsearch01J + '" width="949" height="30" border="0" alt="案件検索">';
var headerAE = '<img src="' + wfsearch01E + '" width="949" height="30" border="0" alt="WORK FLOW SEARCH">';
