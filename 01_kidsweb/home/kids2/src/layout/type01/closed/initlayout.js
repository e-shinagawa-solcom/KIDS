...
///// MAIN MTITLE IMAGE /////
var maintitleJ = '<img src="' + titleJ + '" width="314" height="22" border="0" alt="締め処理">';
var maintitleE = '<img src="' + titleE + '" width="314" height="22" border="0" alt="DATA CLOSED">';



///// INPUT A,B,C HEADER IMAGE /////
var headerAJ = '<img src="' + headertitleJ + '" width="949" height="30" border="0">';
var headerAE = '<img src="' + headertitleE + '" width="949" height="30" border="0" >';
