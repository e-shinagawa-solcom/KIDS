...
var headerAJ = '<img src="' + psheadtitleAJ + '" width="949" height="30" border="0" alt=ユーザー検索">';
var headerAE = '<img src="' + psheadtitleAE + '" width="949" height="30" border="0" alt="USER SEARCH">';
