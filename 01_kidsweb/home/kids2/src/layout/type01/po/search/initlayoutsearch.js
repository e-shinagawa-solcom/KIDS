...
function initLayoutSegs( obj1 , obj2 , obj3 , obj4 , obj5 , obj6 , obj7 , obj8 , obj9 )
{
	...
	if ( obj7 != '')
	{
		for (i = 0; i < lay7.length; i++)
		{
			...
			/*lay7[9].outerHTML = '';*/
			lay7[8].style.background  = '#f1f1f1';
			lay7[8].style.borderColor = '#798787 #e8f0f1 #798787 #798787';
	}
	...
	if ( obj8 != '' )
	{
		for (i = 0; i < lay8.length; i++)
		{
			...
			/*lay8[9].outerHTML = '';*/
			lay8[8].style.background  = '#f1f1f1';
			lay8[8].style.borderColor = '#798787 #798787 #798787 #e8f0f1';
	}
