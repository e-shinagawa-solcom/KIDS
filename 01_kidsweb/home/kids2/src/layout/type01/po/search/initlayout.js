...
var maintitleE = '<img src="' + titleE + '" width="314" height="22" border="0" alt="PURCHASE ORDER">';



///// INPUT A,B,C HEADER IMAGE /////
var headerAJ = '<img src="' + psheadtitleAJ + '" width="949" height="30" border="0" alt="発注検索">';
var headerAE = '<img src="' + psheadtitleAE + '" width="949" height="30" border="0" alt="PO SEARCH">';
