...
///// ADD ROW BT IMAGE /////
var addrowbtJ1 = '<a href="javascript:void(0);"><img onfocus="AddRJOn(this);" onblur="AddRJOff(this);" onmouseover="AddRJOn(this);" onmouseout="AddRJOff(this);fncAlphaOff( this );" onmousedown="fncAlphaOn( this );" onmouseup="fncAlphaOff( this );" src="' + addrowJ1 + '" width="72" height="20" border="0" alt="行追加" tabindex="' + AddRowNum + '"></a>';
...
///// DEL ROW BT IMAGE /////
var delrowbtJ1 = '<a href="javascript:void(0);"><img onfocus="DelRJOn(this);" onblur="DelRJOff(this);" onmouseover="DelRJOn(this);" onmouseout="DelRJOff(this);fncAlphaOff( this );" onmousedown="fncAlphaOn( this );" onmouseup="fncAlphaOff( this );" src="' + delrowJ1 + '" width="72" height="20" border="0" alt="行削除"></a>';
...
///// COMMIT BT IMAGE /////
var commitbtJ1 = '<a href="javascript:void(0);"><img onfocus="CmtJOn(this);" onblur="CmtJOff(this);" onmouseover="CmtJOn(this);" onmouseout="CmtJOff(this);fncAlphaOff( this );" onmousedown="fncAlphaOn( this );" onmouseup="fncAlphaOff( this );" src="' + commitJ1 + '" width="72" height="20" border="0" alt="行確定"></a>';
...
///// REGIST BT IMAGE /////
var registbtJ1 = '<a href="#"><img name="RegistBtImg" onfocus="RegJOn(this);" onblur="RegJOff(this);" onmouseover="RegJOn(this);" onmouseout="RegJOff(this);fncAlphaOff( this );" onmousedown="fncAlphaOn( this );" onmouseup="fncAlphaOff( this );" src="' + registJ1 + '" width="72" height="20" border="0" alt="登録" tabindex="' + RegistNum + '"></a>';
...
var registbtJNotActive = '<img name="RegistBtImg" src="' + registJ1 + '" width="72" height="20" border="0" alt="登録" tabindex="' + RegistNum + '">';
...
///// CLEAR BT IMAGE /////
var clearbtAJ1 = '<a href="javascript:void(0);"><img onfocus="ClearJOn(this);" onblur="ClearJOff(this);" onmouseover="ClearJOn(this);" onmouseout="ClearJOff(this);fncAlphaOff( this );" onmousedown="fncAlphaOn( this );" onmouseup="fncAlphaOff( this );" src="' + clearJ1 + '" width="72" height="20" border="0" alt="クリア"></a>';
...
var clearbtBJ1 = '<a href="javascript:void(0);"><img onfocus="ClearJOn(this);" onblur="ClearJOff(this);" onmouseover="ClearJOn(this);" onmouseout="ClearJOff(this);fncAlphaOff( this );" onmousedown="fncAlphaOn( this );" onmouseup="fncAlphaOff( this );" src="' + clearJ1 + '" width="72" height="20" border="0" alt="クリア"></a>';
...
///// SEARCH BT IMAGE /////
var searchbtAJ1 = '<a href="javascript:void(0);"><img onfocus="SearchJOn(this);" onblur="SearchJOff(this);" onmouseover="SearchJOn(this);" onmouseout="SearchJOff(this);fncAlphaOff( this );" onmousedown="fncAlphaOn( this );" onmouseup="fncAlphaOff( this );" src="' + clearJ1 + '" width="72" height="20" border="0" alt="検索"></a>';
...
///// SELECT BUTTON /////
var selectbtJ1 = '<a href="#"><img onfocus="SelectJOn( this );" onblur="SelectJOff( this);" onmouseover="SelectJOn( this );" onmouseout="SelectJOff( this);fncAlphaOff( this );" onmousedown="fncAlphaOn( this );" onmouseup="fncAlphaOff( this );" src="' + sltbtJ1 + '" width="72" height="20" border="0" alt="選択"></a>';
var selectbtJ3 = '<img src="' + sltbtJ3 + '" width="72" height="20" border="0" alt="選択">';
...
{
	if (typeof(AddRowBt)!='undefined')
	{
		///// ADD ROW BT /////
		AddRowBt.innerHTML = addrowbtJ1;
	}

	if (typeof(DelRowBt)!='undefined')
	{
		///// DEL ROW BT /////
		DelRowBt.innerHTML = delrowbtJ1;
	}

	if (typeof(CommitBt)!='undefined')
	{
		///// COMMIT ROW BT /////
...
/*
		if( typeof(objCheckWorkFlowRoot) != 'undefined' )
		{
			var obj1 = document.HSO.lngWorkflowOrderCode;
			var obj2 = document.DSO.lngWorkflowOrderCode;
		}
		...
		if( typeof(obj1) != 'undefined' )
		{
			...
			{
				if( obj1.options[i].text == '承認なし' )
				{
					if( i == 0 )
					{
						RegistBt.innerHTML = registbtJNotActive;
						fncAlphaOn( document.all.RegistBt );
					}
				}
				else
				{
...
*/
	...
	if (typeof(Confirm1Bt)!='undefined')
	{
		Confirm1Bt.innerHTML = confirmbtJ1;
	}
	if (typeof(Confirm2Bt)!='undefined')
	{
		Confirm2Bt.innerHTML = confirmbtJ1;
	}

/*
	if (typeof(PreSaveBt)!='undefined')
	{
		PreSaveBt.innerHTML = presavebtJ1;
	}
*/

	if (typeof(DecisionBt)!='undefined')
	{
