...
///// MAIN MTITLE IMAGE /////
var maintitleJ = '<img src="' + titleJ + '" width="314" height="22" border="0" alt="受注管理">';
...
var clickable = '#1155ff'; // clickableなカラー

function initLayoutSO()
{
	...
	// *v1* SegA02.style.background = segcolor;
	...
	// *v1* VarsA02.style.background = segcolor;
	...
	// *v1* SegA02.style.borderColor = brcolor01;
	...
	// *v1* VarsA02.style.borderColor = brcolor02;
	...
	SegB03.style.color = clickable;
	SegB03.style.textDecoration = 'underline';
