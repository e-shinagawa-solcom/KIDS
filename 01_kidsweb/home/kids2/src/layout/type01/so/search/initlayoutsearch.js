...
function initLayoutSegs( obj1 , obj2 , obj3 , obj4 , obj5 , obj6 , obj7 , obj8 , obj9 )
{
	...
	if ( obj7 != '')
	{
		...
		lay7[9].style.background  = '#f1f1f1';
		lay7[9].style.borderColor = '#798787 #e8f0f1 #798787 #798787';
	}
	...
	if ( obj8 != '' )
	{
		...
		lay8[9].style.background  = '#f1f1f1';
		lay8[9].style.borderColor = '#798787 #798787 #798787 #e8f0f1';
	}
