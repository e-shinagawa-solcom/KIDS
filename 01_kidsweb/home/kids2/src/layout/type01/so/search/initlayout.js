...
var headerAJ = '<img src="' + sosheadtitleAJ + '" width="949" height="30" border="0" alt="受注検索">';
var headerAE = '<img src="' + sosheadtitleAE + '" width="949" height="30" border="0" alt="SO SEARCH">';
