...
var showGPbt3 = '<a href="#"><img src="' + showwin3 + '" width="19" height="19" border="0" alt="DETAIL"></a>';
	...
	///// GOODS PLAN HEADER /////
var gpheader = '<img src="' + gphead + '" widht="920" height="12" border="0">';


///// INPUT A,B,C HEADER IMAGE /////
var headerAJ = '<img src="' + psheadtitleAJ + '" width="949" height="30" border="0" alt="商品検索">';
var headerAE = '<img src="' + psheadtitleAE + '" width="949" height="30" border="0" alt="PRODUCTS SEARCH">';
