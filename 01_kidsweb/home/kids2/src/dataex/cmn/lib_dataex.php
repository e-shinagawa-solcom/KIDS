...
//	$aryTitleName[6] = "社内統計データ01（売上見込）";
	...
	$aryColumnName[2] = Array ( "仕入計上日", "仕入No", "発注書No", "仕入先コード", "仕入先名称", "部門コード", "部門名称", "カテゴリ", "担当者コード", "担当者名称", "伝票コード", "通貨名称", "レートタイプ", "通貨レート", "支払条件", "製品到着日", "仕入科目コード", "仕入科目名称", "仕入部品コード", "仕入部品名称", "製品コード", "製品名称", "単価", "単位", "数量", "税抜金額", "明細備考" );
	...
	$aryColumnName[4] = Array ( "仕入計上日", "仕入No", "発注書No", "仕入先コード", "仕入先名称", "部門コード", "部門名称", "カテゴリ", "伝票コード", "仕入科目コード", "仕入科目名称", "仕入部品コード", "仕入部品名称", "製品コード", "製品名称", "顧客品番", "単価", "単位", "数量", "税区分", "通貨名称" , "税抜金額", "税額", "合計金額", "合計金額TTM" );
