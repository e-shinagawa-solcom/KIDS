...
function ShowInputA() { //PUSH INPUT A TAB
	...
	document.all.SegBWF.style.visibility      = 'hidden' ;
	document.all.VarsBWF.style.visibility     = 'hidden' ;
	document.all.WFrootBt.style.visibility    = 'hidden' ;
	document.all.WFRootFrame.style.visibility = 'hidden' ;
	//-------------------------------------------------------------------------
...
function ShowInputB() { //PUSH INPUT B TAB
	...
	var strCRC = document.all.strCustomerReceiveCode.value;
	strCRC = trim( strCRC );
	...
	{
		document.all.SegBWF.style.visibility   = 'visible' ;
		document.all.VarsBWF.style.visibility  = 'visible' ;
		document.all.WFrootBt.style.visibility = 'visible' ;
	}
	//-------------------------------------------------------------------------
