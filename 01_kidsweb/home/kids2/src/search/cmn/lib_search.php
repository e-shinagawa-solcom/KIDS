...
$aryTableHeaderName_SC["strslipcode"] = "KWGNO.";
...
$aryTableHeaderName_SLIP["strslipcode"] = "KWGNO.";
...
$aryTableDetailHeaderName_PC["strmoldno"] = "金型NO．";
...
$aryTableDetailHeaderName_INV["strslipcode"] = "KWGNO.";
$aryTableDetailHeaderName_INV["strcustomerno"] = "納品書NO.";
...
$aryTableDetailHeaderName_PURORDER["strproductunitname"] = "製品単位";
...
$aryTableHeadBtnName_MM_LIST["btndetail"] = "詳細";
$aryTableHeaderName_MM_LIST["moldreportid"] = "金型帳票ID";
$aryTableHeaderName_MM_LIST["strcompanydisplaycode"] = "仕入先";
$aryTableHeaderName_MM_LIST["strproductcode"] = "製品コード";
$aryTableHeaderName_MM_LIST["strmoldno"] = "金型NO";
$aryTableHeaderName_MM_LIST["historyno"] = "履歴番号";
$aryTableHeaderName_MM_LIST["strproductname"] = "製品名称";
$aryTableHeaderName_MM_LIST["strproductenglishname"] = "製品名称（英語）";
$aryTableHeaderName_MM_LIST["strgoodscode"] = "顧客品番";
$aryTableHeaderName_MM_LIST["strgroupdisplaycode"] = "担当部署";
$aryTableHeaderName_MM_LIST["struserdisplaycode"] = "担当者";
$aryTableHeaderName_MM_LIST["lngproductquantity"] = "数量";
$aryTableHeaderName_MM_LIST["cursubtotalprice"] = "税抜金額";
$aryTableHeaderName_MM_LIST["status"] = "金型ステータス";
$aryTableHeaderName_MM_LIST["actiondate"] = "実施日";
$aryTableHeaderName_MM_LIST["sourcefactory"] = "保管元工場";
$aryTableHeaderName_MM_LIST["destinationfactory"] = "移動先工場";
$aryTableHeaderName_MM_LIST["created"] = "登録日";
$aryTableHeaderName_MM_LIST["createby"] = "登録者";
$aryTableHeaderName_MM_LIST["updated"] = "更新日";
$aryTableHeaderName_MM_LIST["updateby"] = "更新者";
...
function fncGetDetailData($type, $lngPkNo, $lngRevisionNo, $objDB)
{
    ...
    if ($type == 'inv') { //請求書
        ...
        $aryQuery[] = "        when tpod.lngrevisionno then '削除' ";
        $aryQuery[] = "        else '発注' ";
        $aryQuery[] = "        end ";
        $aryQuery[] = "      else mos.strorderstatusname ";
        $aryQuery[] = "      end";
        $aryQuery[] = "  ) as strorderstatusname";
        ...
        $aryQuery[] = "  , tpod.dtmdeliverydate";
        $aryQuery[] = "  , to_char(tpod.lngProductQuantity, '9,999,999,990') as lngProductQuantity";
        $aryQuery[] = "  , tpod.strProductUnitName";
        $aryQuery[] = "  , tpod.curSubTotalPrice";
        $aryQuery[] = "  , tpod.strNote as strDetailNote";
        $aryQuery[] = "  , tod.strMoldNo ";
        $aryQuery[] = "from";
        $aryQuery[] = "  t_purchaseorderdetail tpod ";
        $aryQuery[] = "  inner join t_orderdetail tod ";
        $aryQuery[] = "    on tod.lngorderno = tpod.lngorderno ";
        $aryQuery[] = "    and tod.lngrevisionno = tpod.lngorderrevisionno ";
        $aryQuery[] = "  inner join m_order mo ";
        $aryQuery[] = "    on mo.lngorderno = tpod.lngorderno ";
        $aryQuery[] = "    and mo.lngrevisionno = tpod.lngorderrevisionno ";
        $aryQuery[] = "  inner join m_orderstatus mos ";
        $aryQuery[] = "    on mos.lngorderstatuscode = mo.lngorderstatuscode ";
        $aryQuery[] = "  inner join m_stocksubject msub ";
        $aryQuery[] = "    on msub.lngstocksubjectcode = tpod.lngstocksubjectcode ";
        $aryQuery[] = "  left join ( ";
        $aryQuery[] = "    select";
        ...
        $aryQuery[] = "      lngpurchaseorderno";
        $aryQuery[] = "  ) min_po ";
        $aryQuery[] = "    on tpod.lngpurchaseorderno = min_po.lngpurchaseorderno ";
        $aryQuery[] = "  left join ( ";
        $aryQuery[] = "    select";
        $aryQuery[] = "      lngpurchaseorderno";
        $aryQuery[] = "      , max(lngrevisionno) as max_lngrevisionno ";
        $aryQuery[] = "    from";
        $aryQuery[] = "      m_purchaseorder ";
        $aryQuery[] = "    group by";
        $aryQuery[] = "      lngpurchaseorderno";
        $aryQuery[] = "  ) max_po ";
        $aryQuery[] = "    on tpod.lngpurchaseorderno = max_po.lngpurchaseorderno ";
        $aryQuery[] = "where";
        $aryQuery[] = "  tpod.lngpurchaseorderno = " . $lngPkNo;
        $aryQuery[] = "  AND tpod.lngrevisionno = " . $lngRevisionNo;
        $aryQuery[] = " ORDER BY";
        $aryQuery[] = "  tpod.lngpurchaseorderdetailno ASC";
    }
    // クエリを平易な文字列に変換
    $strQuery = implode("\n", $aryQuery);
