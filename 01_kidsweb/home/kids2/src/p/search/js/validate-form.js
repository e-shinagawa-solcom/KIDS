...
(function () {
    ...
    var regDate_yymmdd2 = /(19[0-9]{2}|2[0-9]{3})(0[1-9]|1[0-2])([0-2][0-9]|3[0-1])/;
    var regDate_yymm1 = /(19[0-9]{2}|2[0-9]{3})\/(0[1-9]|1[0-2])/;
    var regDate_yymm2 = /(19[0-9]{2}|2[0-9]{3})(0[1-9]|1[0-2])/;
