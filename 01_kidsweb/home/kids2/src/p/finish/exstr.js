...
function fncChgEtoJ()
{
	...
	if ( g_lngCode == 0 )
	{
		...
		ColumnProductsNo.innerText   = 'Product No.';
		ColumnProductsName.innerText = 'Product Name';
		ColumnCreationDate.innerText = 'Creation date';
	...
	else if ( g_lngCode == 1 )
	{
		...
		ColumnProductsNo.innerText   = '製品コード';
		ColumnProductsName.innerText = '製品名称';
		ColumnCreationDate.innerText = '作成日時';
